...
def summarize_and_plot(trials: pd.DataFrame, out_dir: Path) -> None:
    ...
    lines = [
        ...
        "permutation p<.001.",
        "- Metrical-choice pairwise post hoc: 9 of 45 panel pairs tie at the "
        "FDR-corrected floor q=.0005 (most involve Japan or South Africa); no "
        "single pair is resolvable as strongest. See "
