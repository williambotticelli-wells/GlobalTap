...
Runs against the PsyNet exports (not redistributed), and writes the
public tap tables: one row per tap, plus a trial index. Tap onsets are parsed
with the same routine the published analyses use
